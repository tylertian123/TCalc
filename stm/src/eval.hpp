...
namespace eval {
	...
	public:
		enum class Type : uint8_t {
            ...
            TRANSPOSE, INVERSE, NOT_EQUAL, AUGMENT,
	...
	public:
		enum class Type : uint8_t {
			SIN, COS, TAN, ASIN, ACOS, ATAN, ATAN2, SINH, COSH, TANH, ASINH, ACOSH, ATANH, LN, LOG10, LOG2, 
			QUADROOTS, ROUND, MIN, MAX, FLOOR, CEIL, DET, LINSOLVE, LEASTSQUARES, RREF, MEAN, RAND,
