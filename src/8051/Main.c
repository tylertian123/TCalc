...
const unsigned short code KEYMAP_SHIFT[6][10] = {
	...
	{ KEY_LT, KEY_GT, KEY_7, KEY_8, KEY_9, KEY_0, KEY_SUM, KEY_MINUS, KEY_CLEAR, KEY_ALLCLEAR },
...
const unsigned short code KEYMAP_CTRL[6][10] = {
	{ KEY_LCQ, KEY_LCW, KEY_LCE, KEY_LCR, KEY_LCT, KEY_LCY, KEY_LCU, KEY_LCI, KEY_LCO, KEY_PIECEWISE },
	{ KEY_LCA, KEY_LCS, KEY_LCD, KEY_LCF, KEY_GFUNCS, KEY_GSETTINGS, KEY_LCJ, KEY_LCK, KEY_LCL, KEY_CONFIG },
	{ KEY_SHIFT, KEY_LCZ, KEY_LCX, KEY_LCC, KEY_LCV, KEY_LCB, KEY_LCN, KEY_MATRIX, KEY_COMMA, KEY_CTRL },
	{ KEY_LTEQ, KEY_GTEQ, KEY_7, KEY_8, KEY_9, KEY_0, KEY_PLUS, KEY_MINUS, KEY_CLEARVAR, KEY_ALLCLEAR },
	{ KEY_TRIG, KEY_CAT, KEY_4, KEY_5, KEY_6, KEY_DOT, KEY_CROSS, KEY_FRACFMT, KEY_SQUARE, KEY_EXPONENT },
