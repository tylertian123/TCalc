...
const unsigned short code KEYMAP_SHIFT[6][10] = {
	...
	{ KEY_LT, KEY_GT, KEY_7, KEY_8, KEY_9, KEY_0, KEY_SUM, KEY_RARROW, KEY_CLEAR, KEY_ALLCLEAR },
	{ KEY_LOGIC, KEY_RECALL, KEY_4, KEY_5, KEY_6, KEY_DOT, KEY_PRODUCT, KEY_FRAC, KEY_CUBE, KEY_EXPONENT },
